...
var testnetInterface_1 = require('./tests/testnetInterface');
function deployPool() {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          factory_address = factory.contract_address;
          return [
            4 /*yield*/,
            (0, testnetInterface_1.deploy)(
        ...
        case 2:
          deploy_info_dai = _a.sent();
          dai_address = deploy_info_dai.contract_address;
        ...
        case 3:
          deploy_info_erc = _a.sent();
          erc20_address = deploy_info_erc.contract_address;
          console.log(erc20_address);
          return [
            4 /*yield*/,
            (0, testnetInterface_1.invoke)(factory_address, 'createPool_a1671295', [
              dai_address,
              erc20_address,
              '500',
            ]),
