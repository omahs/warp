...
export class DeclarationNameMangler extends ASTMapper {
  ...
  visitForStatement(node: ForStatement, ast: AST): void {
    // We mangle the declarations in for loops because our loop functionalisation extracts
    // declarations to the current scope instead of new making a new scope
