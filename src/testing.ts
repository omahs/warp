...
const expectedResults = new Map<string, ResultType>(
  [
    ...
    ['example_contracts/naming/event', 'WillNotSupport'],
    ['example_contracts/naming/free_function', 'WillNotSupport'],
    ['example_contracts/naming/function', 'WillNotSupport'],
    ['example_contracts/naming/state_variable', 'WillNotSupport'],
    ['example_contracts/naming/struct', 'WillNotSupport'],
    ['example_contracts/naming/variable', 'WillNotSupport'],
